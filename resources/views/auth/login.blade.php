...
<head>
    ...
    <link href="{{ asset('/libs/bower_components/admin-lte/plugins/iCheck/square/blue.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('/libs/bower_components/animate.css/animate.min.css') }}" rel="stylesheet" type="text/css" />

    <!--[if lt IE 9]>
    <script src="{{ asset('/libs/bower_components/html5shiv/dist/html5shiv.min.js') }}"></script>
    <script src="{{ asset('/libs/bower_components/respond/dest/respond.min.js') }}"></script>
    <![endif]-->
...
<!-- jQuery 2.1.3 -->
<script src="{{ asset('/libs/bower_components/admin-lte/plugins/jQuery/jQuery-2.1.3.min.js') }}"></script>
<!-- Bootstrap 3.3.2 JS -->
<script src="{{ asset('/libs/bower_components/admin-lte/bootstrap/js/bootstrap.min.js') }}" type="text/javascript"></script>
<!-- iCheck -->
<script src="{{ asset('/libs/bower_components/admin-lte/plugins/iCheck/icheck.min.js') }}" type="text/javascript"></script>
<script>
    $(function () {
        $('input').iCheck({
